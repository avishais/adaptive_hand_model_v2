...
classdef gp_class < handle
    ...
    methods
        ...
        function obj = load_data(obj)
            ...
            if obj.IsDiscrete
                Q = load('sim_data_discrete_v8_d4_m1.mat');
                Qtest = load('test_v8_d4_m1.mat');
            else
            ...
            Dtest = Qtest.S;
            Atest = [repmat([1,-1], 100, 1);
                repmat([-1,-1], 40, 1);
                repmat([-1,0], 80, 1);
                repmat([1,0], 70, 1);
                repmat([1,-1], 70, 1)];
            Dtest = [Dtest Atest Dtest];
...
%                 obj.I.action_inx = 7:8;
%                 obj.I.state_inx = 1:6;
%                 obj.I.state_nxt_inx = 9:14;
